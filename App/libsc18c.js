...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 25888,
    DYNAMIC_BASE = 5268768,
    DYNAMICTOP_PTR = 25728;
...
var wasmBinaryFile = 'libsc18c.wasm';
...
function getBinaryPromise() {
  ...
  return fetch2(wasmBinaryFile, { credentials: 'same-origin' }).then(function(response) {
      if (!response['ok']) {
        throw "failed to load wasm binary file at '" + wasmBinaryFile + "'";
      }
      return response['arrayBuffer']();
...
/** @type {function(...*):?} */
var _libsc18c_initialize = Module["_libsc18c_initialize"] = createExportWrapper("libsc18c_initialize");

/** @type {function(...*):?} */
var _libsc18c_terminate = Module["_libsc18c_terminate"] = createExportWrapper("libsc18c_terminate");
